...
public enum Device {
  ...
  public var screenRatio: (width: Double, height: Double) {
    ...
    /// Return current screen size in logical points
    public var currentSize: (width: Double, height: Double)  {
    ...
    /// Returns screen size in logical points
    public var screenSize: (width: Double, height: Double) {
        #if os(iOS)
        switch self {
        ...
        case .iPhone15: return (width: 390, height: 844)
        case .iPhone15Plus: return (width: 428, height: 926)
        ...
        case .iPad10: return (width: 820, height: 1180)
        case .iPadAir4: return (width: 820, height: 1180)
        case .iPadAir5: return (width: 820, height: 1180)
        case .iPadAir11M2: return (width: 820, height: 1180)
        case .iPadAir13M2: return (width: 1024, height: 1366)
        ...
        case .iPadPro11Inch4: return (width: 834, height: 1194)
        case .iPadPro12Inch6: return (width: 1024, height: 1366)
        case .iPadPro11M4: return (width: 834, height: 1194)
    ...
    public static var allDevicesWithALidarSensor: [Device] {
      return [.iPhone12Pro, .iPhone12ProMax, .iPhone13Pro, .iPhone13ProMax, .iPhone14Pro, .iPhone14ProMax, .iPhone15Pro, .iPhone15ProMax, .iPadPro11Inch2, .iPadPro12Inch4, .iPadPro11Inch3, .iPadPro12Inch5, .iPadPro11Inch4, .iPadPro12Inch6, .iPadPro11M4, .iPadPro13M4]
    }
    ...
    public static var allDevicesWithUSBCConnectivity: [Device] {
      return [.iPhone15, .iPhone15Plus, .iPhone15Pro, .iPhone15ProMax, .iPad10, .iPadAir4, .iPadAir5, .iPadAir11M2, .iPadAir13M2, .iPadMini6, .iPadPro11Inch, .iPadPro12Inch3, .iPadPro11Inch2, .iPadPro12Inch4, .iPadPro11Inch3, .iPadPro12Inch5, .iPadPro11Inch4, .iPadPro12Inch6, .iPadPro11M4, .iPadPro13M4]
    }
